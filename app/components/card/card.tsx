    ...
    <ComponentWrapper isTouchable={true} onPress={() => props.onPress()}>
      {props.statusText ? (
        <>
          <Text
            preset="description"
            style={[STATUS_TEXT, props.statusTextColor && { color: props.statusTextColor }]}
          >
            {props.statusText}
          </Text>
      ...
      <View style={props.iconName ? MAIN_CONTENT : {}}>
        <Text preset="title" style={[props.subtitle ? TITLE_TEXT : {}]}>
          {props.title}
        </Text>
      ...
      {props.iconName ? (
        <>
          ...
          <View style={ICON_WRAPPER}>
            ...
            <Text
              preset="description"
              style={[ICON_TEXT, props.iconTextColor && { color: props.iconTextColor }]}
            >
              {props.iconText}
            </Text>
          </View>
