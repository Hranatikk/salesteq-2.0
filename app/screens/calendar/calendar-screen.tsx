...
// Components
import { Screen, SimpleBackground, Header, ComponentWrapper, Card, Text } from "../../components"
  ...
  function CalendarScreen() {
    ...
    const getEventsOnDate = () => {
      const events = calendarEvents.filter(
        (i) => dayjs(i.date).format("YYYY-MM-DD") === selectedDate,
      )
      return events
    }
      ...
      return (
        <ComponentWrapper isTouchable={false}>
          <Calendar
            ...
            renderHeader={(date) => <Text>{dayjs(date).format("DD MMMM YYYY")}</Text>}
            theme={{
    ...
    return (
      <View testID="CalendarScreen" style={FULL}>
        ...
        <Screen style={CONTAINER} preset="fixed" backgroundColor={color.transparent}>
          <Header headerTx="calendarScreen.title" style={HEADER} titleStyle={HEADER_TITLE} />
